...
class IndyCredFormatHandler(V30CredFormatHandler):
    ...
    async def create_offer(
        ...
        # print(f"cred_proposal_message {cred_proposal_message}")
        # print(f"its body {cred_proposal_message._body}")
        preview_attrs = {
            attr
    ...
    async def issue_credential(
        ...
        return self.get_format_data(CRED_30_ISSUE, json.loads(cred_json))
